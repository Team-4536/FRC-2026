...
#         self.table.putNumber("limelight ty", self.llTable.getNumber("ty", 0))
#         self.table.putNumber("limelight ta", self.llTable.getNumber("ta", 0))
...
#         ta = Rotation2d.fromDegrees(self.llTable.getNumber("ta", 0))
#         print(self.llTable.getNumber("tx", -1))
#         print(".")
# robotState.limelightPose = Field2d.setRobotPose(tx, ty, ta)
