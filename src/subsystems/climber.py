...
class Climber(Subsystem):
    ...
    def periodic(self, robotState: RobotState) -> RobotState:
        ...
        if robotState.climbDown:
            self.climberMotor.setThrottle(self.getFloat("BAM: climber down throttle", default = -0.7))
            print("climbing up")

        elif robotState.climbUp:
            self.climberMotor.setThrottle(self.getFloat("BAM: climber up throttle", default = 0.7))
            print("climbing down")
